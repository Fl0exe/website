    ...
    <main className={styles.main}>
      ...
      <Card>
        <h3 className={styles.center}>
          The Software and Hardware I have worked with
        </h3>
        <BadgeWall />
      </Card>
      <Card>
        <p>
          I originally made this site to showcase my skills and projects. (It
          does that pretty well as you can see.) It also taught me a lot about
          web-development, git, CI/CD pipelines and Docker.
        </p>
      </Card>
      <Card>
